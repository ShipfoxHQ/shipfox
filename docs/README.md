...
| Adds or changes workflow run concurrency, group arbitration, waiting, reruns, or cancellation boundaries. | [ADR 0016](adr/0016-workflow-run-concurrency.md) | Workflow group scope, latest-wins arbitration, dev isolation, waiting and rerun behavior, event ordering, lock order, and cancellation boundaries. |

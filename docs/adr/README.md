...
| [0016: Workflow run concurrency](0016-workflow-run-concurrency.md) | Proposed | Workflow group scope, latest-wins arbitration, dev isolation, waiting and rerun behavior, event ordering, lock order, and cancellation boundaries. |

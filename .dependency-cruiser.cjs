...
module.exports = {
  forbidden: [
    ...
    ...(['@shipfox/api-definitions', '@shipfox/api-secrets', '@shipfox/api-workflows'].includes(
      ...
      : []),
    ...(['@shipfox/api-agent', '@shipfox/api-integration-clickup', '@shipfox/api-integration-jira', '@shipfox/api-integration-linear', '@shipfox/api-integration-slack', '@shipfox/api-workflows'].includes(currentPackage.name)

...
export const agentThinkingFieldSchema = z
  ...
  .meta({
    description:
      'Sets agent reasoning. `default` requests the provider default without workspace or deployment overrides. Omitting this field uses configured defaults. Available values depend on the harness. Supports workflow expressions. See [Model providers](/reference/model-providers).',
  });

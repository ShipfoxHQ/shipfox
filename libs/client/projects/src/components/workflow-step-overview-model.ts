...
export interface WorkflowStepSelection {
  ...
  readonly step: RunDetailStepDto;
}
...
function fallbackStepName(step: RunDetailStepDto): string {
...
function buildSummary(
  step: RunDetailStepDto,
  currentAttempt: RunDetailStepDto['attempts'][number] | null,
  attempts: RunDetailStepDto['attempts'],

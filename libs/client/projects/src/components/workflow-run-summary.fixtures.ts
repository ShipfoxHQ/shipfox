import type {WorkflowRunSummaryRun} from './workflow-run-summary-model.js';
...
const baseRun = {
  ...
  inputs: null,
} satisfies Omit<WorkflowRunSummaryRun, 'id' | 'status' | 'created_at' | 'updated_at'>;

export const failedWorkflowRunSummaryFixture: WorkflowRunSummaryRun = {
  ...baseRun,
...
export const runningWorkflowRunSummaryFixture: WorkflowRunSummaryRun = {
  ...baseRun,
...
export const succeededWorkflowRunSummaryFixture: WorkflowRunSummaryRun = {
  ...baseRun,
...
export const missingTriggerWorkflowRunSummaryFixture: WorkflowRunSummaryRun = {
  ...baseRun,

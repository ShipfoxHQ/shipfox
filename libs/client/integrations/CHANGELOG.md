...
- Updated dependencies [61f3cfb]
  ...
  - @shipfox/integration-icons@0.4.3
...
- Updated dependencies [3d1afa1]
  ...
  - @shipfox/integration-icons@0.4.1
...
- Updated dependencies [7ed04a3]
  ...
  - @shipfox/api-integration-linear-dto@22.0.0
  - @shipfox/api-integration-sentry-dto@22.0.0
...
- Updated dependencies [7467ee6]
  ...
  - @shipfox/api-integration-linear-dto@20.1.0
  - @shipfox/api-integration-sentry-dto@20.1.0
...
- Updated dependencies [515b14c]
  ...
  - @shipfox/integration-icons@0.3.9
...
- Updated dependencies [79e1ed7]
  ...
  - @shipfox/integration-icons@0.3.8
...
- Updated dependencies [f57bcc3]
  ...
  - @shipfox/api-integration-gitea-dto@16.0.0
  - @shipfox/api-integration-github-dto@16.0.0
  - @shipfox/api-integration-jira-dto@16.0.0
  - @shipfox/api-integration-linear-dto@16.0.0
  - @shipfox/api-integration-sentry-dto@16.0.0
...
- @shipfox/api-integration-linear-dto@15.0.0
- @shipfox/api-integration-sentry-dto@15.0.0
- @shipfox/api-integration-slack-dto@15.0.0
- @shipfox/api-integration-webhook-dto@15.0.0
...
- ddcc546: Closes the integration usage modal through the shared Modal lifecycle instead of unmounting it directly, so it completes its exit animation.

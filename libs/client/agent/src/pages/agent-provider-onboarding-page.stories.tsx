...
interface AgentProviderOnboardingStoryProps {
  scenario: Scenario;
}
...
function AgentProviderOnboardingStory({scenario}: AgentProviderOnboardingStoryProps) {
  configureApiClient({
...
const meta = {
  ...
  component: AgentProviderOnboardingStory,
  parameters: {layout: 'fullscreen'},
  args: {scenario: 'available'},
} satisfies Meta<typeof AgentProviderOnboardingStory>;
...
function fetchForScenario(scenario: Scenario): typeof fetch {
  return (input) => {
    ...
    if (request?.method === 'PUT' && url.pathname.includes('/agent/providers/')) {

...
export const formalizationDocs: readonly FormalizationDoc[] = [
  ...
  },
  {
    ...
    extraSections: [
      ...
      {
        title: 'Example: Stable Graph Dependencies',
        body: [
      ...
      {
        title: 'Example: Shorthand And Defaults',
        body: [
      ...
      {
        title: 'Example: Runtime Commands',
        body: [
      ...
      {
        title: 'Example: Stable Diagnostics',
        body: [

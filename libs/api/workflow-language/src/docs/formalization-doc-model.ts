...
export const formalizationDocs: readonly FormalizationDoc[] = [
  ...
  },
  {
    ...
    title: '004 Core IR',
    status: 'draft',
    sourceOfTruth: 'libs/api/workflow-language/src/core/ir/',
    ...
    generatedLines: ['- WorkflowIR implementation: not present in scaffold commit.'],
    examples: ['A job dependency map becomes explicit IR edges once the normalizer is introduced.'],
    addingOrChanging: [
      'Update IR types, normalizer tests, static semantics, runtime docs, and generated docs when adding IR concepts.',
    ],
    deferredWork: ['- Cached WorkflowIR persistence.'],
  },
  {

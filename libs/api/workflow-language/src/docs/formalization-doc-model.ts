...
export const formalizationDocs: readonly FormalizationDoc[] = [
  ...
  },
  {
    ...
    status: 'draft',
    sourceOfTruth: 'libs/api/workflow-language/src/core/static-semantics/',
    ...
    generatedLines: ['- Static diagnostic registry: not present in scaffold commit.'],
    examples: ['Unknown dependency references and dependency cycles are static semantic errors.'],
    addingOrChanging: [

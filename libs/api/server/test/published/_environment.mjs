export function publishedTestEnvironment() {
  ...
  return {
    ...
    NOTION_OAUTH_CLIENT_ID: 'external-consumer-client-id',
    NOTION_OAUTH_CLIENT_SECRET: 'external-consumer-client-secret',
    NOTION_OAUTH_REDIRECT_URL: 'https://shipfox.example.com/integrations/notion/callback',

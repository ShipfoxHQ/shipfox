...
// case-folding table. These Unicode 17.0.0 CaseFolding.txt entries are the mappings that
// lowercase cannot represent, including full mappings that expand a lowercase code point.

...
export const AGENT_ACCESS_ACTION_CALL_LIMIT = 10;
...
export const AGENT_ACCESS_MCP_INSTRUCTIONS = [
  'This server exposes read tools and action tools for the workspace bound to the authenticated credential. Action tools change workspace state and should run only when the user asked for that action.',

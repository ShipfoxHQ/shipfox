import {type OutboxRegistry, pruneDispatchedOutboxRows} from '@shipfox/node-module';
...
export async function pruneOutboxRetention(outboxRegistry: OutboxRegistry): Promise<void> {
  const results = await pruneDispatchedOutboxRows(outboxRegistry, {

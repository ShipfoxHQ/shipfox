...
When you connect ClickUp, select one workspace. Shipfox uses that workspace for
searches and event delivery. Tools that use a task, List, or comment ID can also
access items in other ClickUp workspaces available to the connected account.

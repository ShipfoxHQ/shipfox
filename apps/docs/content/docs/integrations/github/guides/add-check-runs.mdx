---
title: "Report a Job as a GitHub Check Run"
sidebarTitle: "Report Check Runs"
description: "Publish a command's progress and result as a check run on the commit."
---

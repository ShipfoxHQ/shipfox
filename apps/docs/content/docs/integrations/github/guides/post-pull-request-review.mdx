---
title: "Allow an Agent to Write to GitHub"
sidebarTitle: "Let Agents Write to GitHub"
description: "Grant one agent step a narrow set of GitHub write tools. The example posts a review on a new pull request."
---

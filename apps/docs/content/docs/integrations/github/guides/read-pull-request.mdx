---
title: "Give an Agent Read-Only GitHub Tools"
sidebarTitle: "Give Agents GitHub Tools"
description: "Grant an agent step a selected set of GitHub tools. The example reads a pull request without being able to change GitHub."
---
...
review](/integrations/github/guides/post-pull-request-review) when the task intends
a GitHub write.

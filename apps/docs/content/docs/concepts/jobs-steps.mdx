...
<ParamField path="prompt" type="string" required>
  The instruction sent to the AI model. Supports `${{ }}` interpolation from run and trigger context — see [Expressions](/reference/expressions).
</ParamField>
...
<CardGroup cols={2}>
  ...
  <Card title="Model Providers" icon="microchip" href="/guides/model-providers">

...
sidebarTitle: "Home"
description: "Agent workflows that run like CI pipelines: they live in your repo and turn a ticket, an alert or a failed check into a pull request. You review and merge. Your week goes to the work that needs you."
---

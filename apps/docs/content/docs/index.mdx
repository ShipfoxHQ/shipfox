...
sidebarTitle: "Home"
description: "A ticket, an alert or a failed check starts a workflow in your repo. It runs like a CI pipeline and opens a pull request. You review and merge, and spend your week on the work that needs you."
---

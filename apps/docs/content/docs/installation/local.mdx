...
<Steps>
  ...
  <Step>
    ...
    **Create your account and workspace**
    ...
    ![The create-project form showing the source connection, repository picker, and pre-filled project name](/img/create-project.png)

*Create project: pick the source connection and repository. The name is pre-filled.*
  </Step>
  <Step>

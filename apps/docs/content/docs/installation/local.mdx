...
<Steps>
  ...
  <Step>
    ...
    **Create your account and workspace**
    ...
    <img src="/img/create-project.png" alt="The create-project form showing the source connection, repository picker, and pre-filled project name" />

*Create project: pick the source connection, then the repository — the name is pre-filled.*
  </Step>
  <Step>
    ...
    **Register a runner**
    ...
    <img src="/img/runner-registration-token.png" alt="The create registration token dialog on Settings → Runners, showing the one-time token value and copy button" />

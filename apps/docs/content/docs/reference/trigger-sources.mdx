...
| GitHub | integration connection slug, e.g. `github_acme` | `push` and other repository events | [GitHub](/integrations/github) |
| Sentry | integration connection slug, e.g. `sentry_acme` | `issue.created`, `issue.resolved`, `issue.assigned`, `issue.archived`, `issue.unresolved` | [Sentry](/integrations/sentry) |
| Custom webhook | integration connection slug you choose | `received` | [Custom webhook](/integrations/webhooks) |

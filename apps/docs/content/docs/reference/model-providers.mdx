...
description: "The complete Shipfox agent provider catalog, including each provider ID and default model. Learn how provider configuration and model resolution work."
---
...
see the [Model Providers guide](/how-to/set-up-work/configure-model-providers).
...
<Cards>
  <Card title="Model Providers guide" href="/how-to/set-up-work/configure-model-providers">

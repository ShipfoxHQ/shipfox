...
| App disconnected in Shipfox | Refresh stops immediately. Actions and log downloads stop on their next request. Read calls can continue until the access token expires. |

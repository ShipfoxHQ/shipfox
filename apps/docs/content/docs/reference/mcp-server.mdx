...
import McpSkillResources from '../../generated/reference/mcp-server-resources.mdx';
...
The [skills catalog](/reference/mcp-skills) gives the prompt that starts each
skill.
...
The docs homepage uses `docs://shipfox/home`.
...
resources and search. The default is the [Shipfox docs site](https://www.shipfox.io/docs).

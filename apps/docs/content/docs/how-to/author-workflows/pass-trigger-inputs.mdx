---
title: "Give Each Trigger Its Own Inputs"
sidebarTitle: "Set Inputs per Trigger"
description: "Run the same jobs with different settings depending on how the run started. The example runs smoke tests manually and the full suite on a schedule."
---

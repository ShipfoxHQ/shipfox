---
title: "Filter Which Events Start a Run"
sidebarTitle: "Filter Trigger Events"
description: "Add a trigger filter so unwanted events create no run at all. The example accepts only ready pull requests that target the default branch."
---

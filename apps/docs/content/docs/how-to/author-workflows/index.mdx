...
<Cards>
  ...
  <Card title="Test a workflow against a past event" href="/how-to/author-workflows/test-workflow-against-past-event">
    Check local YAML, replay a real event, and inspect the run with a coding agent.
  </Card>

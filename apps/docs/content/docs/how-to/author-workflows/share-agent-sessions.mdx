---
title: "Continue an Agent's Conversation in a Later Step"
sidebarTitle: "Continue an Agent Session"
...
feedback](/how-to/recipes/bound-listening-job). Replace that job's

---
title: "Test a Workflow Against a Past Event"
sidebarTitle: "Test a Past Event"
description: "Use a coding agent to check local workflow YAML against a past event, run it, and inspect the result."
---

Use this guide when you need to test edited workflow YAML without pushing it.
Your coding agent checks the file against a recorded event before starting a run.
...
## Check the workflow against an event
...
## Understand the local file checkout

---
title: "Decide When a Listening Job Succeeds"
sidebarTitle: "Set Listener Success Rules"
description: "Control how a listening job's executions roll up into its final result. The example fails unless at least one event was processed and every execution succeeded."
---

...
2. Open the custom provider's menu and select **Edit**.
3. Update the endpoint, protocol, headers, or models.
4. Enter a new API key when it changed. Leave it blank to keep the stored key.
5. Choose a valid default model, then select **Test & save**.

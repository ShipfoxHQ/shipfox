---
title: "Set the Workspace's Default Harness, Provider, and Model"
sidebarTitle: "Set the Default Agent Model"
description: "Open source edition only. Choose a harness and model provider. Set workspace defaults and verify them with an agent run."
---
...
<Cards>
  <Card title="Add a custom provider" href="/how-to/set-up-work/manage-model-providers#add-a-custom-provider">

...
- [GitHub integration connection](/how-to/set-up-work/connect-github).
- [Sentry integration connection](/how-to/set-up-work/connect-sentry).
- [Custom webhook](/how-to/set-up-work/create-custom-webhook).

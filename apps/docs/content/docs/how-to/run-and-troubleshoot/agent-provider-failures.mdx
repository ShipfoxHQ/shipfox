...
Use [Agent integration fields](/reference/workflow-schema#agent-integration-fields)
to rebuild the smallest valid selection. For GitHub, see the
[read-only](/integrations/github/guides/read-pull-request) and
[write](/integrations/github/guides/post-pull-request-review) examples.

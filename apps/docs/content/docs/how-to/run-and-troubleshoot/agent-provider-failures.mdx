...
Use [read-only integration tools](/integrations/github/guides/read-pull-request)
or [write-capable integration tools](/integrations/github/guides/post-pull-request-review)

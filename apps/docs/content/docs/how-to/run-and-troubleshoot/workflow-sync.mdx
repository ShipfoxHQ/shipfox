...
| Invalid definition | The named file follows the strict workflow schema and every referenced job, step, connection, and tool exists |
| Repository or file not found | The project still points to a repository visible through its source connection |
| Access denied or connection unavailable | The source integration is installed and authorized for the repository |

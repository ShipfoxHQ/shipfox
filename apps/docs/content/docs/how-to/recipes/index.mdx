...
<Cards>
  ...
  <Card title="Publish a GitHub check run" href="/how-to/recipes/review-with-github-check">
    Start, complete, or clean up a visible GitHub check around a review job.
  </Card>

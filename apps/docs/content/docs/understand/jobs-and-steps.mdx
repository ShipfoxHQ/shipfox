...
The `shipfox` label selects the default hosted runner. The [Hosted runners
reference](/reference/runner-labels) lists the other sizes.
...
placement. [Agent access](/integrations/github/guides/read-pull-request) shows

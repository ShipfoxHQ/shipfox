...
Hosted labels select a documented execution environment and size. The [Hosted
runners reference](/reference/runner-labels) lists their CPU, memory, storage,
...
Use the [Hosted runners reference](/reference/runner-labels) to choose hosted
